...
class MyoLeg(PipelineEnv):
    def __init__(
            self,
            forward_reward_weight=2.55,
        ...
        mj_model.opt.iterations = 15
        mj_model.opt.ls_iterations = 15
    ...
    def step(self, state: State, action: jp.ndarray) -> State:
        ...
        forward_reward = self._forward_reward_weight * -velocity[1]
...
def main(is_msk=True):
    ...
    train_fn = functools.partial(
        ppo.train, num_timesteps=40_000_000, num_evals=7, reward_scaling=0.1,
        episode_length=5000, normalize_observations=True, action_repeat=1,
